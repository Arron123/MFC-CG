...
void CMyView::OnShY() 
{
	...
	for ( i=1;i<=4;++i)
		...
		my1.A[3][3]=1;   
		my1.A[4][4]=1;
		my1.A[2][1]=0;		//为0错切平面离开Z轴，沿Y方向移动
		my1.A[3][2]=1;		//为0错切平面离开X轴，沿Y方向移动
		my1.DrawPers();	
...
void CMyView::OnShZ() 
{
	...
	for ( i=1;i<=4;++i)
		...
		my1.A[3][3]=1;   
		my1.A[4][4]=1;
		my1.A[1][3]=0;   //为0错切平面离开Y轴，沿Z方向移动
		my1.A[2][3]=0.5;		//为0错切平面离开X轴，沿Z方向移动
